...
export const AuthModeTabs = ({ activeMode, onChange }: AuthModeTabsProps) => (
  <div
    ...
    className="grid min-w-0 grid-cols-3 gap-1 rounded-app border border-white/10 bg-background/70 p-1"
    role="tablist"
  >
    {tabs.map((tab) => {
      ...
      return (
        <button
          ...
          className={cn(
            'min-h-10 min-w-0 rounded-app px-2 text-xs font-semibold transition duration-200 ease-app',
            isActive
