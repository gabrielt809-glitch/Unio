...
export const AuthPanel = ({
  ...
  <Surface variant="elevated" className="overflow-hidden p-0">
    <div className="border-b border-white/10 bg-white/[0.03] p-5">
      ...
      <h1 className="mt-4 break-words text-3xl font-extrabold text-text-primary">{title}</h1>
      <p className="mt-3 break-words text-sm leading-6 text-text-secondary">{description}</p>
    </div>

    <div className="grid min-w-0 gap-5 p-5">
      <div className="grid min-w-0 grid-cols-2 gap-3 text-xs text-text-secondary">
        <div className="min-w-0 rounded-app border border-white/10 bg-background/70 p-3">
